...
# Casio F-91W User Manual (Module 593)
...
Holding the right button (ALARM) for 3 seconds in the main timekeeping mode leads the display to show "CASIo", which is useful to spot a counterfeit model.
